...
pub const Config = union(Kind) {
    ...
    /// Tmux displays one pane of a tmux control mode session hosted by
    /// another surface. There is no pty.
...
pub const Backend = union(Kind) {
    ...
    pub fn threadEnter(
        ...
        switch (self.*) {
            ...
            .tmux => |*t| try t.threadEnter(alloc, io, td),
        }
    }
    ...
    pub fn focusGained(
        ...
        switch (self.*) {
            ...
            .tmux => |*t| try t.focusGained(td, focused),
        }
    }
    ...
    pub fn resize(
        ...
        switch (self.*) {
            ...
            .tmux => |*t| try t.resize(grid_size, screen_size),
        }
    }
    ...
    pub fn queueWrite(
        ...
        switch (self.*) {
            ...
            .tmux => |*t| try t.queueWrite(alloc, td, data, linefeed),
        }
    }
    ...
    pub fn childExitedAbnormally(
        ...
        switch (self.*) {
            ...
            .tmux => |*v| try v.childExitedAbnormally(
                gpa,
                t,
                exit_code,
                runtime_ms,
